      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex gap-6 font-medium text-gray-700">
          ...
          <Link
            ...
            className={
              pathname === "/dashboard/provider/jobs"
                ? "text-orange-500"
                : "hover:text-orange-500"
            }
          >
          ...
          <Link
            ...
            className={
              pathname === "/dashboard/provider/agenda"
                ? "text-orange-500"
                : "hover:text-orange-500"
            }
          >
          ...
          <Link
            ...
            className={
              pathname === "/dashboard/provider/messaging"
                ? "text-orange-500"
                : "hover:text-orange-500"
            }
          >
      ...
      {open && (
        <div className="lg:hidden mt-4 px-4 pb-4 space-y-4">
          <nav className="flex flex-col gap-4 text-gray-800 font-medium">
            <Link href="/dashboard/provider">Votre profile</Link>
            <Link href="/dashboard/provider/jobs">Trouver une offre</Link>
            <Link href="/dashboard/provider/agenda">Agenda</Link>
          </nav>
