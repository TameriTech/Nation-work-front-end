      ...
      <div className="container mx-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center">
            <Briefcase className="w-6 h-6 mr-2 text-gray-300 dark:text-gray-600" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-4 border border-gray-200 dark:border-slate-700"
            >
                ...
                {[1, 2, 3, 4, 5].map((row) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="h-3 w-24 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mb-2"></div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="flex items-center">
                            <div className="w-3 h-3 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mr-1"></div>
                    ...
                    {/* Budget */}
                    <td className="px-6 py-4">
                      <div className="h-4 w-20 bg-gray-200 dark:bg-slate-700 rounded animate-pulse mb-1"></div>
                      <div className="h-3 w-16 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <div className="w-8 h-8 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
                        <div className="w-8 h-8 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
                        <div className="w-20 h-8 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
                      </div>
                    </td>
                  </tr>
                ))}
