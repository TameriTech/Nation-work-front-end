// app/(protected)/dashboard/admin/services/error.tsx
"use client";
...
export default function ServicesError({ error, onRetry }: ServicesErrorProps) {
  ...
  const getErrorMessage = () => {
    ...
    if (
      ...
      return "Les services sont introuvables.";
    }
