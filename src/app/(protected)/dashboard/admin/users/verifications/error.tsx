// app/(protected)/dashboard/admin/verifications/error.tsx
"use client";

import { AlertCircle, RefreshCw, Home, ArrowLeft } from "lucide-react";
import { useRouter } from "next/navigation";

interface AdminVerificationsErrorProps {
  error: Error | null;
  onRetry?: () => void;
}

export default function AdminVerificationsError({ error, onRetry }: AdminVerificationsErrorProps) {
  ...
  const getErrorMessage = () => {
    ...
    if (error.message.includes("404") || error.message.includes("introuvable")) {
      return "Les données de vérification sont introuvables.";
    }
    ...
    return error.message || "Une erreur est survenue lors du chargement des vérifications";
  };
      ...
      <div className="max-w-md w-full">
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-slate-700">
          ...
          <div className="p-8 text-center">
            ...
            {/* Détails techniques (optionnel - à n'afficher qu'en développement) */}
          ...
          {/* Pied de page avec code d'erreur */}
